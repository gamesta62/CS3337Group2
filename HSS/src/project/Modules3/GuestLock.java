...
/**
 * Servlet implementation class GuestLock
 */
@WebServlet("/project.Modules3/GuestLock")
public class GuestLock extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int Count = (int)context.getAttribute("Locker");	
			...
			"Failed door unlock attempt by guest detected");
        	}
